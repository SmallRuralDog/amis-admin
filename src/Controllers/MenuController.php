...
use SmallRuralDog\AmisAdmin\Renderers\Json;
...
class MenuController extends AdminController
{
    ...
    protected function grid()
    {
        ...
        return Grid::make($model::query(), 'amis-admin.menu', function (Grid $grid) {
            ...
            $grid->column('order', '排序')->useTableColumn()->quickEdit(['type' => 'input-number']);

            $grid->column('hidden', '隐藏')->useTableColumn()->quickEdit(['type' => 'switch', 'mode' => 'inline']);
        ...
        return Form::make($model::query(), 'amis-admin.menu', function (Form $form) {
            $form->customLayout([
                ...
                Group::make()->body([
                    ...
                    $form->item('icon', '图标')->useFormItem()->clearable(true)
